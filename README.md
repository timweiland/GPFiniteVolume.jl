...
GPFiniteVolume.jl depends on [GaussianMarkovRandomFields.jl](https://github.com/timweiland/GaussianMarkovRandomFields.jl) (registered, requires ≥ 0.11) and [FunctionalGPs.jl](https://github.com/timweiland/FunctionalGPs.jl) (unregistered).  Install via:
